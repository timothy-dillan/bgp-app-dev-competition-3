...
const (
	...
	DB_GET_BID_BY_ID_QUERY         = DB_GET_BIDS_QUERY + " WHERE id = $1"
	DB_GET_BID_BY_PRODUCT_ID_QUERY = DB_GET_BIDS_QUERY + " WHERE product_id = $1"
	DB_GET_BID_BY_USER_ID_QUERY    = DB_GET_BIDS_QUERY + " WHERE owner = $1 or original_owner = $1"
	DB_INSERT_BID_QUERY            = "INSERT INTO biddings (id, bidder, product_id, bidding_price) VALUES ($1, $2, $3, $4) RETURNING id;"
)
